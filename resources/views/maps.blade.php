...
*/
    ...
    // Google maps API shown over here
    var map = new google.maps.Map(document.getElementById('map'), {
      zoom: 6,
      center: new google.maps.LatLng(41.693630, 44.801620),
    ...
    for (i = 0; i < values.length; i++) {  
      marker = new google.maps.Marker({
        position: new google.maps.LatLng(values[i][7], values[i][8]),
        map: map
      });

      google.maps.event.addListener(marker, 'click', (function(marker, i) {
        return function() {
          infowindow.setContent(values[i]);
 ...
 <!--  <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDyRzVZMmLgPCmrZmGG0hn2uMmIp1UHNdc&callback=initMap"
  type="text/javascript"></script> -->

  <!-- AIzaSyDyRzVZMmLgPCmrZmGG0hn2uMmIp1UHNdc -->
</body>
</html>